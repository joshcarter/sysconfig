...
(defvar artist-mode-map
  (let ((map (make-sparse-keymap)))
    ...
    (define-key map [down-mouse-2] 'artist-down-mouse-3)
    (define-key map [S-down-mouse-2] 'artist-down-mouse-3)
    (define-key map [down-mouse-3] 'artist-mouse-choose-operation)
    (define-key map [S-down-mouse-3] 'artist-mouse-choose-operation)
